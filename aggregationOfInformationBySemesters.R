...
dfSPVSNR<-distinct(dfAAUMarriedGrades, SPV, studienr)
...
ECTSovw<-merge(ECTSovw,dfSPVSNR)
...
ForSvante<-merge(dfEnrolStatus,ectsAggsAll,by.x =c("studienr","stype"),by.y =c("studienr","type"))

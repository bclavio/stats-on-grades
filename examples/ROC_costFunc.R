...
df <- read_and_prepare_titanic_dataset("C:/Users/BiancaClavio/Documents/PBLstats-on-grades/examples/titanic3.csv")

# logistic regression model with leave-10-out CV

...
ECTSattainedMelted<- merge(dfAAUMarriedGrades[dfAAUMarriedGrades$isPassed==1,c("bctdf", "studienr","type","takenInSem", "ECTS")] , StudieNRSkeleton,by.x = c("studienr", "type","bctdf"),by.y =c("studienr", "stype","CTdf") ,all.y)
ECTSattmptedMelted<- merge(dfAAUMarriedGrades[,c("bctdf", "studienr","type","takenInSem", "ECTS")] , StudieNRSkeleton,by.x = c("studienr", "type","bctdf"),by.y =c("studienr", "stype","CTdf") ,all.y)

...
personalized_info <- read.csv("MidtermGrades.csv", stringsAsFactors = FALSE)
...
studentTable <- melt(subset(personalized_info[,-c(1,13, 25:26)], personalized_info$rowID %in% personalized_info$rowID[i]))
studentTable1<- NULL

...
[^1]: A *boxplot* illustrates the full range of variation (from min to max), the likely range of variation (IQR), and a typical value (median). The rectangular box denotes the IQR, corresponding to the middle scores of the dataset. The line dividing the box into two parts marks the median. The upper and lower lines (also called whiskers) represent the highest scores (upper line) and the lowest scores (lower line). Outliers are defined as data points outside the whiskers and plotted as black dots. 

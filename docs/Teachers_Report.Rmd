...
```{r echo=FALSE, warning=FALSE, out.width='.49\\linewidth', fig.width=4, fig.height=6,fig.show='hold',fig.align='center'}
...
ggplot(dfSSPgradesStat, aes(rowSums(dfSSPgradesStat))) + 
  ...
  scale_x_continuous(breaks=seq(5,11,1), limits = c(5,11)) 
...
kable(studyHoursTable, caption = "Distribution of study hours a week") %>% kable_styling(bootstrap_options = "striped", full_width = F)
```

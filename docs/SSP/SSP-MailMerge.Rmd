...
p2 <- add_sub(p, "Figure 3: Radar chart of the median self-ratings of all students in seven topics (red) \nin comparison to your score (blue).", x = 0, hjust = 0, size=25)
ggdraw(p2)
...
Find your student counseler[here](https://www.en.aau.dk/education/bachelor/medialogy/student-guidance/) (https://www.en.aau.dk/education/bachelor/medialogy/student-guidance/).

\pagebreak


*IDEA: give room for annotations/ notes*

This should be a tool for you to grow as a student.
You can use this analysis to set concrete goals (e.g. using the SMART method). 
Look at the area(s) where you agree with the analysis and set goals for next semester.
...
This prepares you for the seminar in PV that we have on the test results. You can also use this information when you work in your study group, e.g. you can share weaknesses/strengths and what motivates you. 
...
My motivation for studying Medialogy
\newline

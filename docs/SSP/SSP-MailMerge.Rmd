...
#studyingHours <- 38
# Study and work
selectRecommondations[6,1] <- ifelse(studyingHours>=55, "much higher than the recommended",ifelse(studyingHours>=47, "sufficient",
  ifelse(studyingHours>=42 && studyingHours<=46, "about the recommended",
  ifelse(studyingHours>=10 && studyingHours<=41, "less than the recommended", "much less than the recommended or entered an unrecognized entry in the questionnaire"))))
